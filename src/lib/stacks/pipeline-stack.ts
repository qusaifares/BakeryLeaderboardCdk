...
export class PipelineStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const pipelineSecret = new secretsmanager.Secret(this, 'BakeryLeaderboardPipelineSecret', {
    });
    ...
    const pipeline = new codepipeline.Pipeline(this, 'BakeryLeaderboardPipeline', {
